Streetwear Sales EDA Project
Project Overview

This project performs an Exploratory Data Analysis (EDA) on a Streetwear sales dataset to extract meaningful insights and trends. The goal is to understand sales patterns, identify top-selling products, and provide actionable recommendations for business strategy. The analysis uses Python with libraries such as Pandas, NumPy, Matplotlib, and Seaborn.
